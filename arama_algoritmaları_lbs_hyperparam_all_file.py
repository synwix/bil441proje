...
lbs_params = [
    ...
    {"beam_width": 20, "max_iterations": 100},  # 1: Sadece beam_width
    {"beam_width": 10, "max_iterations": 150},  # 2: Sadece max_iterations
    {"beam_width": 5, "max_iterations": 100},   # 3: Sadece beam_width azalt
    {"beam_width": 20, "max_iterations": 150},  # 4: beam_width + max_iterations
    {"beam_width": 20, "max_iterations": 50},   # 5: beam_width + max_iterations azalt
    {"beam_width": 5, "max_iterations": 150},   # 6: beam_width azalt + max_iterations
    {"beam_width": 5, "max_iterations": 50},    # 7: beam_width ve max_iterations azalt
    {"beam_width": 30, "max_iterations": 100},  # 8: beam_width daha fazla
    {"beam_width": 30, "max_iterations": 150}   # 9: beam_width ve max_iterations maksimum
]
...
with open("lbs_hyperparam_results.txt", "w") as f:
